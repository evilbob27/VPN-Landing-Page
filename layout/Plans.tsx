        ...
        <section className="flex flex-col items-center mt-16 mb-16">
            ...
            <ul className="flex flex-row justify-around mx-80 mt-16">
                {plansItems.map(({id, img, name, price, list}) => (
                    <li key={id}
                        className="flex flex-col items-center justify-start border-2 border-slate-200 rounded-xl mx-6 w-[20.5rem]">
                        ...
                        <ul className="flex-1 mb-[2.75rem]">
                            ...
                            <button className="px-14 py-2 border-2 border-red-600 rounded-3xl font-bold text-red-600 mb-12">
                                Select
                            </button>
                    </li>
                ))}
