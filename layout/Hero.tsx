    ...
    return (
        <section className="grid grid-cols-2 max-w-[1300px] mx-auto px-6 gap-16 bg-white">
            <article className=" flex flex-col my-auto">
                ...
                <p className="text-slate-700 mb-12 leading-normal">Provide a network for all your needs with ease and
                    fun using <span
                        className="font-medium">LaslesVPN</span> <br/>
                    discover interesting features from us.</p>
                <button
                    className="bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl justify-items-start w-[15rem] h-14">
                    Get Started
                </button>
            </article>
